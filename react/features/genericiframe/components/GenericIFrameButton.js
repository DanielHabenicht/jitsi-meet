...
function _mapStateToProps(state: Object, ownProps: Object) {
    const { documentUrl, visible } = state["features/genericiframe"];
    const { propVisible = Boolean(documentUrl) } = ownProps;

    return {
        _visible: propVisible ? propVisible : visible,
    };
}

export default connect(_mapStateToProps)(GenericIFrameButton);
